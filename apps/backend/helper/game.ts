import {type gameObject, gameOverReasons, type moveSocketResponse } from '@schach/common/interfaces/game';
import { type gameState } from '@schach/common/interfaces/enums';
