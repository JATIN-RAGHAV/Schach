import { getInitialGameObject } from "@schach/common/game";
import { color, gameTypes } from "@schach/common/interfaces/enums";
import type { gameObject, gameOverReasons } from "@schach/common/interfaces/game";
