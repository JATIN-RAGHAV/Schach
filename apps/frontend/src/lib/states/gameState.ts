...
import { Pieces, type color, type gameTypes } from "@schach/common/interfaces/enums";
import { gameState as gameStateType } from "@/pages/play/lib";
import type { Board, moveSocketResponse, startGameResponse } from "@schach/common/interfaces/game";
import { initBoard, moveCharsToIndex } from "@schach/common/game";
import { color as colors } from "@schach/common/interfaces/enums";
