...
export const WhiteKing: React.FC<{ size?: number }> = ({ size = 45 }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width={size} height={size}>
    <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M22.5 25s4.5-7.5 3-10.5c0 0-1-2.5-3-2.5s-3 2.5-3 2.5c-1.5 3 3 10.5 3 10.5"
        fill="#fff" strokeLinecap="butt" strokeLinejoin="miter" />
...
export const WhiteQueen: React.FC<{ size?: number }> = ({ size = 45 }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width={size} height={size}>
...
export const WhiteRook: React.FC<{ size?: number }> = ({ size = 45 }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width={size} height={size}>
    <g fill="#fff" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M14 29.5v2h17v-2" strokeLinecap="butt" strokeLinejoin="miter" />
    </g>
  </svg>
)

export const WhiteBishop: React.FC<{ size?: number }> = ({ size = 45 }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width={size} height={size}>
    <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export const WhiteKnight: React.FC<{ size?: number }> = ({ size = 45 }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width={size} height={size}>
    <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export const WhitePawn: React.FC<{ size?: number }> = ({ size = 45 }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width={size} height={size}>
...
export const BlackKing: React.FC<{ size?: number }> = ({ size = 45 }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width={size} height={size}>
    <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M22.5 11.63V6" strokeLinejoin="miter" />
      <path d="M22.5 25s4.5-7.5 3-10.5c0 0-1-2.5-3-2.5s-3 2.5-3 2.5c-1.5 3 3 10.5 3 10.5"
        fill="#000" strokeLinecap="butt" strokeLinejoin="miter" />
      <path d="M11.5 37c5.5 3.5 15.5 3.5 21 0v-7s9-4.5 6-10.5c-4-6.5-13.5-3.5-16 4V27v-3.5c-3.5-7.5-13-10.5-16-4-3 6 5 10 5 10V37z"
        fill="#000" />
...
export const BlackQueen: React.FC<{ size?: number }> = ({ size = 45 }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width={size} height={size}>
    <g fill="#000" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M11 29a35 35 1 0 1 23 0M12.5 31.5h20M11.5 34.5a35 35 1 0 0 22 0" fill="none" stroke="#fff" />
    </g>
  </svg>
)

export const BlackRook: React.FC<{ size?: number }> = ({ size = 45 }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width={size} height={size}>
    <g fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M9 39h27v-3H9v3z" fill="#000" strokeLinecap="butt" />
      <path d="M12.5 32l1.5-2.5h17l1.5 2.5h-20z" fill="#000" strokeLinecap="butt" />
      <path d="M12 36v-4h21v4H12z" fill="#000" strokeLinecap="butt" />
      <path d="M14 29.5v-13h17v13H14z" fill="#000" strokeLinecap="butt" strokeLinejoin="miter" />
      <path d="M14 16.5L11 14h23l-3 2.5H14z" fill="#000" strokeLinecap="butt" />
      <path d="M11 14V9h4v2h5V9h5v2h5V9h4v5H11z" fill="#000" strokeLinecap="butt" />
      <path d="M12 35.5h21M13 31.5h19M14 29.5h17M14 16.5h17M11 14h23" fill="none" stroke="#fff" strokeWidth="1" strokeLinejoin="miter" />
    </g>
  </svg>
)

export const BlackBishop: React.FC<{ size?: number }> = ({ size = 45 }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width={size} height={size}>
    <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export const BlackKnight: React.FC<{ size?: number }> = ({ size = 45 }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width={size} height={size}>
    <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export const BlackPawn: React.FC<{ size?: number }> = ({ size = 45 }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width={size} height={size}>
    <path d="M22.5 9c-2.21 0-4 1.79-4 4 0 .89.29 1.71.78 2.38C17.33 16.5 16 18.59 16 21c0 2.03.94 3.84 2.41 5.03C15.41 27.09 11 31.58 11 39.5H34c0-7.92-4.41-12.41-7.41-13.47C28.06 24.84 29 23.03 29 21c0-2.41-1.33-4.5-3.28-5.62.49-.67.78-1.49.78-2.38 0-2.21-1.79-4-4-4z"
...
export const EmptySquare: React.FC<{ size?: number }> = ({ size = 45 }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width={size} height={size}>
    <rect width="45" height="45" fill="none" stroke="#000" strokeWidth="0" />
  </svg>
)

export const PieceComponents: Record<Pieces, React.FC<{ size?: number }>> = {
  'WK': WhiteKing,
  'WQ': WhiteQueen,
  'WR': WhiteRook,
  'WB': WhiteBishop,
