...
import { userCreateZod,type userCreate } from "@schach/common/interfaces/userZodTypes";
import {
    Field,
    FieldGroup,
    FieldLabel,
...
export function SignupForm({
    ...
    const form = useForm<userCreate>({
        resolver: zodResolver(userCreateZod),
        defaultValues: {
            username: "",
            password: "",
        },
        ...
        <form className={cn("flex flex-col gap-6", className)} {...props}>
            <FieldGroup>
                ...
                <Field>
                    ...
                    Already a user?
                    <Button variant="link" size="sm" className="inline" onClick={() => {navigate("/login")}}>Login</Button>
                    </div>
                    </Field>
                    {
