...
import { type moveSocketResponse ,gameOverReasons, type startGameResponse, type moveSocketRequest} from "../interfaces/game";
...
const printMoveResponse = (response:moveSocketResponse,moveNumber:number,player:string) => {
    ...
    console.log(`Why Over: ${gameOverReasons[response.whyOver as gameOverReasons]}`);
    console.log()
    console.log()
}
